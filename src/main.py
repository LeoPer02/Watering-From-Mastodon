...
class Pools(db.Model):
    ...
    pool_date = db.Column(db.DateTime, default=datetime.datetime.utcnow)
    ...
    for i in control_agents:
        ...
        for j in pools:
            temp = {
                ...
                "date": str(j.pool_date)
            }
            # Used to avoid duplicates generated by MQTT
            temp_no_date = {
                "id": j.id,
                "ca": j.ca,
                "light_value": j.light_value,
